...
def receive_event():
	"""POST /api/method/friday.friday_core.surfaces.slack_adapter.receive_event
...
def _handle_event(event: dict) -> None:
	...
	from friday.friday_core.gateway.commands import is_command
...
def _handle_command(channel: str, user: str, content: str) -> None:
	...
	"""
	from friday.friday_core.gateway.commands import dispatch_command
