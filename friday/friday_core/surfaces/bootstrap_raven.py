...
installed on the site:
  ...
  4. The `raven` Chat Platform row: dispatch_mode "async" (the dedicated
    ...
    bench --site friday.localhost execute \\
        friday.friday_core.surfaces.bootstrap_raven.provision
"""

from __future__ import annotations

import frappe
from friday.friday_core.surfaces.raven_adapter import FRIDAY_BOT_NAME, RAVEN_PLATFORM
	...
	frappe.get_doc(
		{
			...
			"adapter_module": "friday.friday_core.surfaces.raven_adapter",
			"enabled": 1,
