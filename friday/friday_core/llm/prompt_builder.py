...
- `friday/friday_core/skills/loader.py` — `load_for_profile()`
"""
...
import frappe
from friday.friday_core.llm.compression import SUMMARY_PREFIX, latest_summary
from friday.friday_core.llm.memory import project_for_session, recall_block
from friday.friday_core.llm.project_context import project_snapshot_block
from friday.friday_core.llm.references import expand_references
from friday.friday_core.skills.loader import (
	SkillDefinition,
	to_tool_definition,
)
