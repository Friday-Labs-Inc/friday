...
import frappe
from friday.friday_core.a2a.task_store import (
    CANCELED,
    COMPLETED,
    FAILED,
    TERMINAL,
...
def handle():
    """POST /api/method/friday.friday_core.a2a.server.handle — the A2A server endpoint.
...
def agent_card():
    ...
    """
    from friday.friday_core.a2a.card import build_agent_card
