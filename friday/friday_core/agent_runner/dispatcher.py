...
import frappe
from friday.friday_core.agent_runner.sanitize import repair_tool_arguments
from friday.friday_core.approvals.workflow import create_request, requires_approval
from friday.friday_core.permissions.matrix import Decision
from friday.friday_core.permissions.matrix import check as matrix_check
...
from friday.friday_core.skills.registry import (  # noqa: E402
	_SKILL_HANDLERS,
	get_skill_handler,
...
def dispatch(
	...
	from friday.friday_core.sandbox.credentials import resolve_credentials
	...
	try:
		...
		if handler is None:
			...
			from friday.friday_core.skills.handlers_mcp import resolve_handler
...
def _execute_sandboxed(
	...
	"""
	from friday.friday_core.sandbox import handlers as sandbox_handlers
	from friday.friday_core.sandbox.runner import SandboxResult, execute
