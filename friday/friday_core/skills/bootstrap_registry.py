...
DEFINITION_ENSURES: tuple[str, ...] = (
	"friday.friday_core.skills.bootstrap_files.ensure_definitions",
	"friday.friday_core.skills.bootstrap_read.ensure_definitions",
	"friday.friday_core.skills.bootstrap_propose_skill.ensure_definitions",
	"friday.friday_core.skills.bootstrap_delegate.ensure_definitions",
	"friday.friday_core.skills.bootstrap_deliverables.ensure_definitions",
)
