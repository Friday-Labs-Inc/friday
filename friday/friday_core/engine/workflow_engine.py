...
from friday.friday_core.engine import bundle, phase_dispatcher
...
def _announce_human_pause(doc, workflow: str, state: str) -> None:
	...
	try:
		...
		frappe.enqueue(
			"friday.friday_core.engine.workflow_engine._post_pause_message",
			text=text,
...
def _post_pause_message(text: str) -> None:
	...
	try:
		from friday.friday_core.warroom.publisher import _get_channel_id, _post_to_raven
