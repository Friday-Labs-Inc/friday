...
from friday.friday_core.skills import handlers_project
from friday.friday_core.tasks import dispatcher as task_dispatcher

_D = "friday.friday_core.tasks.dispatcher"
_H = "friday.friday_core.skills.handlers_project"
_RUN = "friday.friday_core.agent_runner.runner.run_turn"
...
class TestAgenticRunner(unittest.TestCase):
	...
	@patch("friday.friday_core.tasks.runner.now_datetime")
	@patch(_RUN, return_value="Strategy drafted.")
	@patch("friday.friday_core.tasks.runner.frappe")
	...
	@patch("friday.friday_core.tasks.runner.now_datetime")
	@patch("friday.friday_core.tasks.runner._post_warroom")
	@patch("friday.friday_core.tasks.runner._raise_failure_issue", return_value="ISS-9")
