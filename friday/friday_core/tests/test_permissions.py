...
`friday/friday_core/permissions/` actually does what its docstrings
...
==========
    ...
    bench --site friday.localhost run-tests \\
        --module friday.friday_core.tests.test_permissions
"""
...
import frappe
from friday.friday_core.permissions import cache as cache_module
from friday.friday_core.permissions import matrix as matrix_module
from friday.friday_core.permissions.matrix import (
	Decision,
	PermissionMatrix,
	build_matrix,
	check,
