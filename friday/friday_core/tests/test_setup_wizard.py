...
class TestSaveProvider(unittest.TestCase):
	@patch("friday.friday_core.setup.wizard.cli_setup")
	@patch("friday.friday_core.setup.wizard.frappe")
	def test_delegates_sets_costs_and_default(self, mock_frappe, mock_cli):
		from friday.friday_core.setup import wizard
...
class TestProvisionSurfaces(unittest.TestCase):
	...
	@patch("friday.friday_core.surfaces.bootstrap_raven.provision")
	@patch("friday.friday_core.setup.wizard.frappe")
...
class TestProvisionTools(unittest.TestCase):
	@patch("friday.friday_core.skills.bootstrap_files.provision")
	@patch("friday.friday_core.skills.bootstrap_read.provision")
	@patch("friday.friday_core.setup.wizard.frappe")
...
class TestVerifyAndComplete(unittest.TestCase):
	@patch("friday.friday_core.health.pipeline_health.pipeline_health")
	@patch("friday.friday_core.llm.model_discovery.list_models")
	@patch("friday.friday_core.setup.wizard.frappe")
