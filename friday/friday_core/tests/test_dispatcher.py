...
==========
    ...
    bench --site friday.localhost run-tests \
        --module friday.friday_core.tests.test_dispatcher
...
import frappe
from friday.friday_core.agent_runner.dispatcher import (
	_SKILL_HANDLERS,
	DispatchResult,
	dispatch,
...
class TestAgentTurnIdentity(unittest.TestCase):
	...
	def test_skill_runs_as_agent_user_and_ambient_is_restored(self):
		...
		from friday.friday_core.agent_runner import dispatcher as d
