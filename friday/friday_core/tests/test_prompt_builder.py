...
SCOPE
=====
These tests verify that `build()` (from `friday.friday_core.llm.prompt_builder`)
...
==========
    bench --site friday.localhost run-tests \
        --module friday.friday_core.tests.test_prompt_builder

SEE ALSO
========
- `friday/friday_core/llm/prompt_builder.py` — the module under test.
...
import frappe
from friday.friday_core.llm.prompt_builder import _build_system_prompt, _load_history, build
from friday.friday_core.skills.loader import SkillDefinition
