...
from friday.friday_core.llm import memory, references
from friday.friday_core.skills import handlers_memory

_M = "friday.friday_core.llm.memory"
_R = "friday.friday_core.llm.references"
_H = "friday.friday_core.skills.handlers_memory"
_PB = "friday.friday_core.llm.prompt_builder"
...
class TestExpandReferences(unittest.TestCase):
	...
	def test_expands_readable_existing_record(self, mock_frappe):
		...
		with patch(
			"friday.friday_core.permissions.matrix.build_matrix",
