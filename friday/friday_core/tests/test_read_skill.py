...
_H = "friday.friday_core.skills.handlers_read"
...
class TestReadRecordParameterValidation(unittest.TestCase):
	...
	def test_missing_doctype_raises(self, mock_frappe):
		from friday.friday_core.skills.handlers_read import read_record
...
class TestListRecords(unittest.TestCase):
	...
	@patch(f"{_H}.frappe")
	def test_missing_doctype_raises(self, mock_frappe):
		from friday.friday_core.skills.handlers_read import list_records
