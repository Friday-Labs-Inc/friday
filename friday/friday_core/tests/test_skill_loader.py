...
==========
    ...
    bench --site friday.localhost run-tests \\
        --module friday.friday_core.tests.test_skill_loader
"""
...
import frappe
from friday.friday_core.skills import loader as loader_module
...
class TestSkillLoader(unittest.TestCase):
	...
	def test_role_gate_dict_fallback_for_unset_field(self):
		...
		from friday.friday_core.skills.loader import _ROLE_GATED_SKILLS
