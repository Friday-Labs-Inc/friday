...
_RB = "friday.friday_core.tasks.report_back"
_PUB = "friday.friday_core.warroom.publisher"
...
class TestWarRoomSpeakerIdentity(unittest.TestCase):
	...
	def test_format_leads_with_agent_profile(self):
		from friday.friday_core.warroom.publisher import _format_message_text
