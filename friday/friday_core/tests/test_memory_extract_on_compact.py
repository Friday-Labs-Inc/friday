...
from friday.friday_core.llm import compression as C
...
# anywhere in the suite (CI saw it kill eight unrelated modules).
_EMB = "friday.friday_core.llm.embed.enqueue_embed"
_C = "friday.friday_core.llm.compression"
_MEM = "friday.friday_core.llm.memory.project_for_session"
