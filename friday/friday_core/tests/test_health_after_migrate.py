...
class TestRegisterFridayQueue(unittest.TestCase):
	...
	@patch("friday.friday_core.health.after_migrate.frappe")
	def test_adds_friday_when_workers_block_absent(self, mock_frappe):
		from friday.friday_core.health.after_migrate import (
	...
	def test_preserves_other_workers(self, mock_frappe):
		from friday.friday_core.health.after_migrate import register_friday_queue
