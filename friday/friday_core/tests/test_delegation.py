...
class TestDelegationRoleGate(unittest.TestCase):
    ...
    def _call(self, parent_role, **overrides):
        ...
        with patch("friday.friday_core.skills.handlers_delegate.frappe", mock_frappe):
            with patch(
                "friday.friday_core.skills.handlers_delegate._get_delegation_settings",
                return_value=(3, 8),
            ):
...
class TestDelegationDepthGate(unittest.TestCase):
    ...
    def _call_at_depth(self, current_depth, max_depth=3):
        ...
        with patch("friday.friday_core.skills.handlers_delegate.frappe", mock_frappe):
            with patch(
                "friday.friday_core.skills.handlers_delegate._delegation_depth",
...
class TestChildTaskCreation(unittest.TestCase):
    ...
    def _delegate_and_capture(self):
        ...
        def mock_get_doc(spec):
            if isinstance(spec, dict) and spec.get("doctype") == "Agent Job":
