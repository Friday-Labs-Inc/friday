...
from friday.friday_core.connectors import client as connector_client
from friday.friday_core.connectors import core

_CORE = "friday.friday_core.connectors.core"
_CLIENT = "friday.friday_core.connectors.client"
