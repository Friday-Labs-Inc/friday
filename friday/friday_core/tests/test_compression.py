...
from friday.friday_core.llm.compression import (
	SUMMARY_PREFIX,
	_format_transcript,
	_split_middle_tail,
...
from friday.friday_core.llm.prompt_builder import _load_history
from friday.friday_core.llm.provider import LLMError

_C = "friday.friday_core.llm.compression"
...
class TestSummaryPrefix(unittest.TestCase):
	...
	def test_summariser_prompt_has_structured_sections(self):
		...
		from friday.friday_core.llm.compression import _SUMMARISER_SYSTEM
...
class TestPromptBuilderCompaction(unittest.TestCase):
	...
	@patch("friday.friday_core.llm.prompt_builder.latest_summary", return_value="THE SUMMARY")
	...
	@patch("frappe.get_all")
	@patch("friday.friday_core.llm.prompt_builder.latest_summary", return_value=None)
