...
from friday.friday_core.skills import handlers_deliverables as hd

_H = "friday.friday_core.skills.handlers_deliverables"
_MEM = "friday.friday_core.llm.memory.project_for_session"


class TestShareDeliverables(unittest.TestCase):
	@patch("friday.friday_core.gateway.mirror.mirror_to_session")
