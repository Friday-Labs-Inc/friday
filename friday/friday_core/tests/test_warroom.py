...
class TestPostTaskUpdateRavenInstalledChannelFound(unittest.TestCase):
	...
	@patch("friday.friday_core.warroom.publisher._post_to_raven")
	@patch("friday.friday_core.warroom.publisher._get_channel_id")
	@patch("friday.friday_core.warroom.publisher._is_raven_installed")
...
class TestPostTaskUpdateRavenNotInstalled(unittest.TestCase):
	...
	@patch("friday.friday_core.warroom.publisher._get_channel_id")
	@patch("friday.friday_core.warroom.publisher._post_to_raven")
	@patch("friday.friday_core.warroom.publisher._logger")
...
class TestIsRavenInstalledDoctypeExists(unittest.TestCase):
	...
	@patch("friday.friday_core.warroom.publisher.frappe")
	def test_returns_true_when_doctype_exists(self, mock_frappe):
		from friday.friday_core.warroom.publisher import _is_raven_installed
...
class TestGetChannelId(unittest.TestCase):
	...
	def test_returns_channel_name_when_found(self, mock_frappe):
		from friday.friday_core.warroom.publisher import _get_channel_id
...
class TestBuildPayload(unittest.TestCase):
	...
	def test_text_contains_task_name_and_event(self):
		from friday.friday_core.warroom.publisher import _build_payload
...
class TestPostToRavenInProcess(unittest.TestCase):
	...
	def test_posts_as_friday_bot(self, _mock_exists, mock_get_doc):
		from friday.friday_core.warroom.publisher import _post_to_raven
	...
	def test_no_http_post(self):
		...
		from friday.friday_core.warroom import publisher
