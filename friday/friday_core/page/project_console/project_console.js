...
class ProjectConsole {
	...
	refresh() {
		frappe.call({
			method: "friday.friday_core.console.console_snapshot.console_snapshot",
	...
	_render_projects(projects) {
		...
		projects.forEach((p) => {
			...
			const is_work_item = p.kind === "work_item";
