...
import frappe
from friday.friday_core.approvals.workflow import approve, reject
...
def _cmd_stop(session_id: str, user: str, args: list[str]) -> CommandResult:
	...
	"""
	from friday.friday_core.gateway.interrupt import cascade_interrupt, request_interrupt
...
def _cmd_steer(session_id: str, user: str, args: list[str]) -> CommandResult:
	...
	"""
	from friday.friday_core.gateway.steer import push_steer
