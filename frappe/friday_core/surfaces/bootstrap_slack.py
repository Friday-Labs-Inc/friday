...
Subscriptions request URL at `…/api/method/frappe.friday_core.surfaces.slack_adapter.receive_event`.
"""
...
_ADAPTER_MODULE = "frappe.friday_core.surfaces.slack_adapter"
