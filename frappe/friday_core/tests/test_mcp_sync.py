...
class TestSync(unittest.TestCase):
	@patch("frappe.friday_core.mcp.sync.now_datetime", return_value="2026-06-13 12:00:00")
	@patch("frappe.friday_core.mcp.sync.client")
	@patch("frappe.friday_core.mcp.sync.frappe")
...
class TestHandler(unittest.TestCase):
	@patch("frappe.friday_core.skills.handlers_mcp.mcp_sync")
	@patch("frappe.friday_core.skills.handlers_mcp.client")
	@patch("frappe.friday_core.skills.handlers_mcp.frappe")
	def test_invoke_success(self, mock_frappe, mock_client, mock_sync):
		from frappe.friday_core.skills import handlers_mcp
