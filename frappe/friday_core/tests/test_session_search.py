...
_SS = "frappe.friday_core.skills.handlers_session_search"
_M = "frappe.friday_core.llm.after_migrate"


class TestSessionSearch(unittest.TestCase):
	@patch(f"{_SS}.frappe")
	def test_requires_query(self, fr):
		from frappe.friday_core.skills import handlers_session_search as h
