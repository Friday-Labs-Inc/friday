...
class TestProvisionAgentUser(unittest.TestCase):
	...
	@patch("frappe.friday_core.identity.agent_identity.frappe")
...
class TestProvisionAllAgentUsers(unittest.TestCase):
	...
	@patch("frappe.friday_core.identity.agent_identity.provision_agent_user")
	@patch("frappe.friday_core.identity.agent_identity.frappe")
	def test_backfills_each_profile(self, mock_frappe, mock_provision):
		from frappe.friday_core.identity.agent_identity import provision_all_agent_users
...
class TestAfterInsertHook(unittest.TestCase):
	...
	def test_after_insert_delegates(self, mock_frappe, mock_provision):
		from frappe.friday_core.identity.agent_identity import on_agent_profile_after_insert
