...
class TestIsExpiring(unittest.TestCase):
	@patch("frappe.friday_core.llm.oauth.tokens.now_datetime")
...
class TestStoreTokens(unittest.TestCase):
	@patch("frappe.friday_core.llm.oauth.tokens.frappe")
...
class TestGetFreshAccessToken(unittest.TestCase):
	@patch("frappe.friday_core.llm.oauth.tokens.is_expiring", return_value=False)
	@patch("frappe.friday_core.llm.oauth.tokens.frappe")
	...
	@patch("frappe.friday_core.llm.oauth.tokens._refresh_for_flavor")
	@patch("frappe.friday_core.llm.oauth.tokens.is_expiring", return_value=True)
	@patch("frappe.friday_core.llm.oauth.tokens.frappe")
