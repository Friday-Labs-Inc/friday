...
class TestStartDevice(unittest.TestCase):
	@patch("frappe.friday_core.llm.oauth.codex.requests")
	@patch("frappe.friday_core.llm.oauth.codex.frappe")
...
class TestPollDevice(unittest.TestCase):
	...
	@patch("frappe.friday_core.llm.oauth.codex.now_datetime", return_value=_FIXED_NOW)
	@patch("frappe.friday_core.llm.oauth.codex.tokens")
	@patch("frappe.friday_core.llm.oauth.codex.requests")
	@patch("frappe.friday_core.llm.oauth.codex.frappe")
